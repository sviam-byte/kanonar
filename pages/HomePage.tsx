...
const entryPoints = [
    ...
    { type: "goal-lab", name: "GoalLab", description: "Лаборатория контекста: pipeline, POMDP, граф целей, анализ решений.", link: ROUTES.labs.goalLab },
    { type: "simulation-hub", name: "Симуляция", description: "Оркестратор сценариев: SimKit, запуск тиков, каталог готовых симуляций.", link: ROUTES.simulation.hub },
