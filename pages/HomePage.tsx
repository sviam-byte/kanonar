...
const entryPoints = [
    ...
    { type: EntityType.Place, name: "Места", description: "Локации, имеющие значение." },
    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {entryPoints.map(entry => (
             <Link key={entry.type} to={`/${entry.type}`} className="block p-6 bg-canon-bg-light border border-canon-border rounded-lg hover:border-canon-accent hover:shadow-lg hover:shadow-canon-accent/10 transition-all transform hover:-translate-y-1">
