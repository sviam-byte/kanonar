    ...
    chapters: [
      {
        ...
        contentAnchor: 'глава-ii-разделённый-стек-управления-регнум',
        clauses: [
      ...
      },
      {
        ...
        contentAnchor: 'глава-ii-bis-конклав-хранителей-времени',
        clauses: [
    ...
    chapters: [
      {
        ...
        contentAnchor: 'глава-iii-гражданство-как-динамический-процесс',
        clauses: [
      ...
      },
      {
        ...
        contentAnchor: 'глава-iii-bis-хартия-личной-суверенности',
        clauses: [
      ...
      },
      {
        ...
        contentAnchor: 'глава-iii-ter-контур-психической-когерентности',
        clauses: [
      ...
      },
      {
        ...
        contentAnchor: 'глава-iii-quater-биологический-статус-и-жизненный-цикл',
        clauses: [
    ...
    chapters: [
      {
        ...
        contentAnchor: 'глава-iv-законодательный-конвейер-фильтр-от-глупости',
        clauses: [
      ...
      },
      {
        ...
        contentAnchor: 'глава-iv-bis-контуры-знания',
        clauses: [
      ...
      },
      {
        ...
        contentAnchor: 'глава-v-метрическая-политика-и-sre',
        clauses: [
      ...
      },
      {
        ...
        contentAnchor: 'глава-vi-протоколы-операций-и-режимы-аллостатическое-управление',
        clauses: [
      ...
      },
      {
        ...
        contentAnchor: 'глава-vii-чёрный-пуск-blackstart',
        clauses: [
    ...
    chapters: [
      {
        ...
        contentAnchor: 'глава-viii-система-юстиции',
        clauses: [
      ...
      },
      {
        ...
        contentAnchor: 'глава-viii-bis-протоколы-безопасности',
        clauses: [
      ...
      },
      {
        ...
        contentAnchor: 'глава-viii-ter-гражданский-кодекс-и-гарантии',
        clauses: [
      ...
      },
      {
        ...
        contentAnchor: 'глава-xi-публичность-среда-и-фактор-человека',
        clauses: [
      ...
      },
      {
        ...
        contentAnchor: 'глава-xi-bis-протоколы-памяти',
        clauses: [
    ...
    chapters: [
      {
        ...
        contentAnchor: 'глава-ix-экономические-контуры',
        clauses: [
      ...
      },
      {
        ...
        contentAnchor: 'глава-ix-bis-экономика-предсказуемости-и-обязательств',
        clauses: [
      ...
      },
      {
        ...
        contentAnchor: 'глава-x-форки-и-совместимость-fork-хартия',
        clauses: [
      ...
      },
      {
        ...
        contentAnchor: 'глава-xii-эволюция-крк-право-как-код',
        clauses: [
      ...
      },
      {
        ...
        contentAnchor: 'глава-xiii-глубокое-время-и-смысл',
        clauses: [
      ...
      },
      {
        ...
        contentAnchor: 'глава-xiv-внешние-протоколы-и-экзистенциальные-риски',
        clauses: [
    ...
    chapters: [
      {
        ...
        contentAnchor: 'глава-xv-эволюция-регламента',
        clauses: [
      ...
      },
      {
        ...
        contentAnchor: 'глава-xv-bis-протокол-системного-самоустранения',
        clauses: [
    ...
    chapters: [
      {
        ...
        contentAnchor: 'глава-xvi-производственные-контуры-и-ресурсные-циклы',
        clauses: [
      ...
      },
      {
        ...
        contentAnchor: 'глава-xvii-управление-энтропией-и-инфра-гигиена',
        clauses: [
    ...
    chapters: [
      {
        ...
        contentAnchor: 'глава-xviii-единый-регламент-публикаций',
        clauses: [
...
export const NarrativePage: React.FC = () => {
  ...
  const chapterContentMap = useMemo(() => {
    const map = new Map<string, string>();
    const regex = /<h4 id="([^"]+)">/g;
    const matches: { id: string; index: number }[] = [];
    let match: RegExpExecArray | null;

    while ((match = regex.exec(homeostasisNarrativeText)) !== null) {
      matches.push({ id: match[1], index: match.index });
    }

    matches.forEach((current, idx) => {
      const nextIndex = idx + 1 < matches.length ? matches[idx + 1].index : homeostasisNarrativeText.length;
      map.set(current.id, homeostasisNarrativeText.slice(current.index, nextIndex).trim());
    });
              ...
              <div className="grid gap-4 lg:grid-cols-2">
                {section.chapters.map(chapter => (
                  <Card key={chapter.id} id={chapter.id} className="flex flex-col gap-3">
                    ...
                    {chapter.contentAnchor && chapterContentMap.get(chapter.contentAnchor) ? (
                      <div
                        className="whitespace-pre-wrap text-sm text-white leading-relaxed space-y-2"
                        dangerouslySetInnerHTML={{
                          __html: chapterContentMap.get(chapter.contentAnchor) as string,
                        }}
                      />
                    ) : (
