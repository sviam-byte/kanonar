    ...
    <header className={`border-b p-3 md:p-4 sticky top-0 z-50 backdrop-blur-md transition-colors duration-500 ${isAdmin ? 'bg-red-950/80 border-red-900/50' : 'bg-canon-bg/90 border-canon-border'}`}>
      ...
      <div className="flex min-w-0 flex-col gap-3 xl:flex-row xl:items-center xl:gap-8">
        ...
        <nav className="flex flex-wrap items-center gap-3 md:gap-4 lg:gap-6">
            ...
            <NavDropdown 
                label="Lab & Edit" 
                active={isGroupActive(['/builder', '/character-lab', '/planning-lab', '/dialogue-lab', '/dialogue-lab-v2', '/dialogue-lab-v3', '/compare', '/biography-lab', '/presets', '/goal-lab', '/goal-lab-console', '/simulator', '/relations-lab', '/location-constructor', '/dilemma-lab', '/mafia-lab'])}
            ...
            >
                ...
                <NavItem to="/dialogue-lab-v3" label="💬 Dialogue v3" active={isActive('/dialogue-lab-v3')} />
