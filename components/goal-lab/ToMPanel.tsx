...
export const ToMPanel: React.FC<{
    atoms: ContextAtom[];
    ...
    const parsePolicy = (id: string) => {
        ...
        if ((parts[1] === 'predict' || parts[1] === 'att' || parts[1] === 'help') && parts.length >= 5) {
            return { type: parts[1] as 'predict' | 'att' | 'help', self: parts[2], other: parts[3], key: parts.slice(4).join(':') };
        }
