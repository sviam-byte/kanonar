...
const data: CharacterEntity = {
    entityId: "common_worker_delta",
    type: EntityType.Character,
    title: "Кетиль",
    subtitle: "Простой рабочий Дельты",
    authors: [{ name: "auto_extract", role: "Source" }],
    year: "409",
    versionTags: [Branch.Current],
    status: "published",
    tags: ["дельта-5", "рабочий", "быт", "сообщество"],
    description: "Приземлённый голос доски. Быт, шутки, точные наблюдения.",
    relations: [
        { type: "befriends", entityId: "h2-ops", entityTitle: "Хальвард" }
    ],
    media: [],
    evidenceIds: [],
