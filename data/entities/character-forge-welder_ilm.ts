...
const data: CharacterEntity = {
    entityId: "forge-welder_ilm",
    type: EntityType.Character,
    title: "Арни",
    subtitle: "Сварщик из Илмаринена",
    authors: [{ name: "auto_extract", role: "Source" }],
    year: "409",
    versionTags: [Branch.Current],
    status: "published",
    tags: ["поверхность", "промышленный-8", "сварка", "TB"],
    description: "Прямой технарь с Поверхности. Сравнивает стандарты, не стесняется говорить \"так нельзя\".",
    relations: [
        { type: "argues_with", entityId: "techie-linus", entityTitle: "Линн" }
    ],
    media: [],
    evidenceIds: ["ev::oxygen-thread"],
    ...
    parameters: [
        ...
        { key: "ideology_rigidity", name: "Жесткость идеологии", description: "Жесткость убеждений.", min: 0, max: 100, step: 1, defaultValue: 25, canonValue: 25, category: 'limitations' },
