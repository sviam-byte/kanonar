...
const data: CharacterEntity = {
    entityId: "gossip-monger_central",
    type: EntityType.Character,
    title: "Равн",
    subtitle: "Сплетник из коридоров власти",
    authors: [{ name: "auto_extract", role: "Source" }],
    year: "409",
    versionTags: [Branch.Current],
    status: "published",
    tags: ["сплетни", "власть", "инсайд", "намёки"],
    description: "Инсайдер полунамёков. Сеет вопросы вместо ответов.",
    relations: [
        { type: "trades_with", entityId: "assi-the-runner", entityTitle: "Асси" },
        { type: "follows", entityId: "curator-ice", entityTitle: "Лед" }
    ],
    media: [],
    evidenceIds: [],
