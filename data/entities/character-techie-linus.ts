...
const data: CharacterEntity = {
    ...
    status: "published",
    tags: ["техузел", "техник", "рационалист"],
    description: "Рационалист-объяснитель. Любит разбирать аномалии технически.",
    relations: [
        { type: "supplies", entityId: "assi-the-runner", entityTitle: "Асси" },
        { type: "argues_with", entityId: "arch-quietus", entityTitle: "Хедин" }
    ],
    media: [],
    evidenceIds: [],
