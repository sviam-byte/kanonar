...
const data: CharacterEntity = {
    entityId: "student-kaelen",
    type: EntityType.Character,
    title: "Каэлен",
    subtitle: "Каэлен, прагматик",
    authors: [{ name: "auto_extract", role: "Source" }],
    year: "410",
    versionTags: [Branch.Current],
    status: "published",
    tags: ["студент", "прагматик", "университет"],
    description: "Приземлённый друг-соперник Лиры. Юмор как охлаждение идеализма.",
    relations: [
        { type: "student_of", entityId: "magister-silas", entityTitle: "Силас" },
    ...
    parameters: [
        ...
        { key: "approval_level", name: "Уровень согласования", description: "Требуемый уровень согласования для действий.", min: 0, max: 100, step: 1, defaultValue: 15, canonValue: 15, category: 'mandates' },
        ...
        { key: "intel_access", name: "Доступ к данным", description: "Доступ к разведданным/информации.", min: 0, max: 100, step: 1, defaultValue: 40, canonValue: 40, category: 'abilities' },
        ...
        { key: "accountability", name: "Подотчетность", description: "Ответственность за провалы.", min: 0, max: 100, step: 1, defaultValue: 15, canonValue: 15, category: 'limitations' },
