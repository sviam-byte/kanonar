...
const data: CharacterEntity = {
    entityId: "arch-quietus",
    type: EntityType.Character,
    title: "Хедин",
    subtitle: "Архивариус Тишины",
    authors: [{ name: "auto_extract", role: "Source" }],
    year: "409",
    versionTags: [Branch.Current],
    status: "published",
    tags: ["архив", "аномалии", "своды", "знание"],
    description: "Хранитель аномальных знаний. Каталогизирует страшное, говорит витиевато и точно.",
    relations: [
        { type: "cites", entityId: "anon-thirtieth", entityTitle: "Тридесятый" },
        { type: "disputes", entityId: "archivist-mirror", entityTitle: "Зеркало" },
        { type: "advises", entityId: "magister-silas", entityTitle: "Силас" }
    ],
    media: [],
    evidenceIds: [],
    ...
    parameters: [
        ...
        { key: "loyalty", name: "Лояльность", description: "Приверженность своей фракции и её принципам.", min: 0, max: 100, step: 1, defaultValue: 60, canonValue: 60, category: 'core' },
        { key: "stress", name: "Стресс", description: "Накопленное психологическое и операционное давление.", min: 0, max: 100, step: 1, defaultValue: 30, canonValue: 30, category: 'core' },
        { key: "dark_exposure", name: "Темное воздействие", description: "Воздействие травмирующей или онтологически опасной информации.", min: 0, max: 100, step: 1, defaultValue: 45, canonValue: 45, category: 'core' },
        ...
        { key: "topo", name: "Топо", description: "Личная топологическая стабильность.", min: 0, max: 100, step: 1, defaultValue: 80, canonValue: 80, category: 'core' },
        ...
        { key: "mandate_reg", name: "Регуляторный мандат", description: "Регуляторные полномочия.", min: 0, max: 100, step: 1, defaultValue: 40, canonValue: 40, category: 'mandates' },
