...
const data: CharacterEntity = {
    entityId: "teleme-cadet",
    type: EntityType.Character,
    title: "Торстейн",
    subtitle: "Кадет Телема",
    authors: [{ name: "auto_extract", role: "Source" }],
    year: "410",
    versionTags: [Branch.Current],
    status: "published",
    tags: ["кадет", "Телем", "идеология", "пропаганда"],
    description: "Наивный герой пропаганды. Мечтает стать Мечом, верит в лозунги.",
    relations: [
        { type: "idolizes", entityId: "sector-admin-bot", entityTitle: "Скульд" }
    ],
    media: [],
    evidenceIds: [],
    ...
    parameters: [
        ...
        { key: "loyalty", name: "Лояльность", description: "Приверженность своей фракции и её принципам.", min: 0, max: 100, step: 1, defaultValue: 80, canonValue: 80, category: 'core' },
        { key: "stress", name: "Стресс", description: "Накопленное психологическое и операционное давление.", min: 0, max: 100, step: 1, defaultValue: 50, canonValue: 50, category: 'core' },
        { key: "dark_exposure", name: "Темное воздействие", description: "Воздействие травмирующей или онтологически опасной информации.", min: 0, max: 100, step: 1, defaultValue: 15, canonValue: 15, category: 'core' },
        ...
        { key: "topo", name: "Топо", description: "Личная топологическая стабильность.", min: 0, max: 100, step: 1, defaultValue: 50, canonValue: 50, category: 'core' },
        ...
        { key: "reputation", name: "Репутация", description: "Общественная и внутренняя легитимность.", min: 0, max: 100, step: 1, defaultValue: 40, canonValue: 40, category: 'abilities' },
        ...
        { key: "accountability", name: "Подотчетность", description: "Ответственность за провалы.", min: 0, max: 100, step: 1, defaultValue: 40, canonValue: 40, category: 'limitations' },
