...
const data: CharacterEntity = {
    ...
    title: "Сверкер",
    subtitle: "Оператор связи, Тишина-7",
    authors: [{ name: "auto_extract", role: "Source" }],
    year: "410",
    versionTags: [Branch.Current],
    status: "published",
    tags: ["связь", "станция", "сигнал", "Тишина-7"],
    description: "Дисциплинированный и любопытный. Поднял аномальный сигнал, попал под разнос.",
    relations: [
        { type: "reports_to", entityId: "duty-officer-landa", entityTitle: "Ланда" }
    ],
    media: [],
    evidenceIds: ["ev::signal-clip-t7"],
