...
const data: CharacterEntity = {
    entityId: "molot-trainee",
    type: EntityType.Character,
    title: "Бьёрн",
    subtitle: "Новобранец \"Молота\"",
    authors: [{ name: "auto_extract", role: "Source" }],
    year: "410",
    versionTags: [Branch.Current],
    status: "published",
    tags: ["новобранец", "Молот", "казарма", "фронт"],
    description: "Пылкий и пугливый одновременно. Учится держать протокол под лицом аномалий.",
    relations: [
        { type: "trained_by", entityId: "deicide-mentor", entityTitle: "Старкад" },
        { type: "same_unit_as", entityId: "molot-scout", entityTitle: "Скьольд" }
    ],
    media: [],
    evidenceIds: ["ev::breathing-wall-obs"],
    ...
    parameters: [
        ...
        { key: "topo", name: "Топо", description: "Личная топологическая стабильность.", min: 0, max: 100, step: 1, defaultValue: 45, canonValue: 45, category: 'core' },
        ...
        { key: "competence_op", name: "Операционная комп.", description: "Операционная/логистическая компетентность.", min: 0, max: 100, step: 1, defaultValue: 40, canonValue: 40, category: 'abilities' },
        { key: "reputation", name: "Репутация", description: "Общественная и внутренняя легитимность.", min: 0, max: 100, step: 1, defaultValue: 30, canonValue: 30, category: 'abilities' },
