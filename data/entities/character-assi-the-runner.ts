...
const data: CharacterEntity = {
    ...
    relations: [
        { type: "buys_from", entityId: "techie-linus", entityTitle: "Линн" },
        { type: "sells_to", entityId: "gossip-monger_central", entityTitle: "Равн" }
    ],
    media: [],
    evidenceIds: [],
    ...
    parameters: [
        ...
        { key: "loyalty", name: "Лояльность", description: "Приверженность своей фракции и её принципам.", min: 0, max: 100, step: 1, defaultValue: 30, canonValue: 30, category: 'core' },
        ...
        { key: "causal_penalty", name: "Каузальный штраф", description: "Личное участие в действиях, рискующих каузальной целостностью.", min: 0, max: 100, step: 1, defaultValue: 20, canonValue: 20, category: 'core' },
        ...
        { key: "privacy_cost_epsilon", name: "Стоимость приватности (ε)", description: "Риск, связанный с инвазивностью сбора данных.", min: 0, max: 100, step: 1, defaultValue: 60, canonValue: 60, category: 'limitations' },
