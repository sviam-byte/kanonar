...
const data: CharacterEntity = {
    entityId: "caravaneer-yusuf",
    type: EntityType.Character,
    title: "Юсуф",
    subtitle: "Гость Пактового Каравана",
    authors: [{ name: "auto_extract", role: "Source" }],
    year: "410",
    versionTags: [Branch.Current],
    status: "published",
    tags: ["поверхность", "торговля", "шлюз-3", "традиции"],
    description: "Чужак традиций частной собственности. В культурном шоке от общих порядков.",
    relations: [
        { type: "advised_by", entityId: "leila-daughter-of-adata", entityTitle: "Лейла" }
    ],
    media: [],
    evidenceIds: ["ev::gate3-thread-yusuf"],
