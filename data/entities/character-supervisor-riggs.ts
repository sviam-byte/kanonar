...
const data: CharacterEntity = {
    entityId: "supervisor-riggs",
    type: EntityType.Character,
    title: "Риггс",
    subtitle: "Риггс, внутренний контроль",
    authors: [{ name: "auto_extract", role: "Source" }],
    year: "410",
    versionTags: [Branch.Current],
    status: "published",
    tags: ["внутренний контроль", "регламент", "администрация"],
    description: "Человек системы. Канцелярит как оружие, порядок как цель. Видим и слышим всё.",
    relations: [
        { type: "manages", entityId: "auditor-trainee-ro", entityTitle: "Ро" },
        { type: "receives_reports_from", entityId: "moderator_unit_3", entityTitle: "Скади‑3" }
    ],
    media: [],
    evidenceIds: [],
    ...
    parameters: [
        ...
        { key: "loyalty", name: "Лояльность", description: "Приверженность своей фракции и её принципам.", min: 0, max: 100, step: 1, defaultValue: 75, canonValue: 75, category: 'core' },
        ...
        { key: "mandate_reg", name: "Регуляторный мандат", description: "Регуляторные полномочия.", min: 0, max: 100, step: 1, defaultValue: 70, canonValue: 70, category: 'mandates' },
        { key: "approval_level", name: "Уровень согласования", description: "Требуемый уровень согласования для действий.", min: 0, max: 100, step: 1, defaultValue: 80, canonValue: 80, category: 'mandates' },
