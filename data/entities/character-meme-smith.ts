...
const data: CharacterEntity = {
    ...
    title: "Оддвар",
    subtitle: "Кузнец Мемов",
    authors: [{ name: "auto_extract", role: "Source" }],
    year: "410",
    versionTags: [Branch.Current],
    status: "published",
    tags: ["мемы", "юмор", "юг-7", "уличная культура"],
    description: "Уличный шутник. Смех как вентиляция стресса, язвит власть.",
    relations: [
        { type: "taunts", entityId: "supervisor-riggs", entityTitle: "Риггс" },
        { type: "banters_with", entityId: "food-critic-88", entityTitle: "Сигурд" }
    ],
    media: [],
    evidenceIds: [],
    changelog: [{ version: "1.0", date: "410 OВ", author: "System", summary: "Initial record creation." }],
    parameters: [
        { key: "will", name: "Воля", description: "Решимость и ментальная стойкость персонажа.", min: 0, max: 100, step: 1, defaultValue: 50, canonValue: 50, category: 'core' },
