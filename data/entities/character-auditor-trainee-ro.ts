...
const data: CharacterEntity = {
    entityId: "auditor-trainee-ro",
    type: EntityType.Character,
    title: "Ро",
    subtitle: "Внутренний контроль",
    authors: [{ name: "auto_extract", role: "Source" }],
    year: "410",
    versionTags: [Branch.Current],
    status: "published",
    tags: ["внутренний контроль", "регламент", "ревизия"],
    description: "Педант буквы регламента. Фиксирует всё, даже если начальству неудобно.",
    relations: [
        { type: "reports_to", entityId: "supervisor-riggs", entityTitle: "Риггс" }
    ],
    media: [],
    evidenceIds: [],
