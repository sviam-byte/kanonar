...
const data: CharacterEntity = {
    entityId: "student-mavir",
    type: EntityType.Character,
    title: "Мавир",
    subtitle: "Мавир, идеалист-новичок",
    authors: [{ name: "auto_extract", role: "Source" }],
    year: "410",
    versionTags: [Branch.Current],
    status: "published",
    tags: ["студент", "идеалист", "университет", "поверхность"],
    description: "Студент с Поверхности. Между верой в Систему и эмпатией. Хочет справедливости по правилам.",
    relations: [
        { type: "peer_of", entityId: "student-lira_genetics", entityTitle: "Лира" },
        { type: "argues_with", entityId: "civ-student", entityTitle: "Орм" }
    ],
    media: [],
    evidenceIds: [],
    ...
    parameters: [
        ...
        { key: "approval_level", name: "Уровень согласования", description: "Требуемый уровень согласования для действий.", min: 0, max: 100, step: 1, defaultValue: 30, canonValue: 30, category: 'mandates' },
        ...
        { key: "ideology_rigidity", name: "Жесткость идеологии", description: "Жесткость убеждений.", min: 0, max: 100, step: 1, defaultValue: 15, canonValue: 15, category: 'limitations' },
