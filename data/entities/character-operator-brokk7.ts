...
const data: CharacterEntity = {
    entityId: "operator-brokk7",
    type: EntityType.Character,
    title: "Брокк",
    subtitle: "Оператор узла B-23",
    authors: [{ name: "auto_extract", role: "Source" }],
    year: "410",
    versionTags: [Branch.Current],
    status: "published",
    tags: ["оператор", "узел", "цех", "порядок"],
    description: "Коллективист цеха. Прямота и порядок на уровне дела.",
    relations: [
        { type: "coordinates_with", entityId: "h2-ops", entityTitle: "Хальвард" }
    ],
    media: [],
    evidenceIds: [],
    ...
    parameters: [
        ...
        { key: "approval_level", name: "Уровень согласования", description: "Требуемый уровень согласования для действий.", min: 0, max: 100, step: 1, defaultValue: 25, canonValue: 25, category: 'mandates' },
