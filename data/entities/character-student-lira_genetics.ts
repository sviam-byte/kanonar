...
const data: CharacterEntity = {
    entityId: "student-lira_genetics",
    type: EntityType.Character,
    title: "Лира",
    subtitle: "Лира, студентка-генетик",
    authors: [{ name: "auto_extract", role: "Source" }],
    year: "410",
    versionTags: [Branch.Current],
    status: "published",
    tags: ["студент", "генетика", "мечтатель", "университет"],
    description: "Мечтательница, ищет живую красоту науки. Склонна к онтологическим метафорам.",
    relations: [
        { type: "student_of", entityId: "magister-silas", entityTitle: "Силас" },
        { type: "peer_of", entityId: "student-kaelen", entityTitle: "Каэлен" }
    ],
    media: [],
    evidenceIds: [],
    ...
    parameters: [
        ...
        { key: "dark_exposure", name: "Темное воздействие", description: "Воздействие травмирующей или онтологически опасной информации.", min: 0, max: 100, step: 1, defaultValue: 35, canonValue: 35, category: 'core' },
