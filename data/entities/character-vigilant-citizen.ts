...
const data: CharacterEntity = {
    entityId: "vigilant-citizen",
    type: EntityType.Character,
    title: "Эйндриди",
    subtitle: "Бдительный гражданин",
    authors: [{ name: "auto_extract", role: "Source" }],
    year: "409",
    versionTags: [Branch.Current],
    status: "published",
    tags: ["гражданин", "осторожность", "версии"],
    description: "Осторожный версионщик. Предпочитает перестраховаться, задаёт настороженные вопросы.",
    relations: [
        { type: "follows", entityId: "arch-quietus", entityTitle: "Хедин" }
    ],
    media: [],
    evidenceIds: [],
    changelog: [{ version: "1.0", date: "409 OВ", author: "System", summary: "Initial record creation." }],
    parameters: [
        { key: "will", name: "Воля", description: "Решимость и ментальная стойкость персонажа.", min: 0, max: 100, step: 1, defaultValue: 45, canonValue: 45, category: 'core' },
