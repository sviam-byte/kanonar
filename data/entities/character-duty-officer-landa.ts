...
const data: CharacterEntity = {
    entityId: "duty-officer-landa",
    type: EntityType.Character,
    title: "Ланда",
    subtitle: "Начальник смены, Тишина-7",
    authors: [{ name: "auto_extract", role: "Source" }],
    year: "410",
    versionTags: [Branch.Current],
    status: "published",
    tags: ["станция", "смена", "дисциплина", "Тишина-7"],
    description: "Бытовая власть изоляции. Жёсткая дисциплина, защита смены любой ценой.",
    relations: [
        { type: "supervises", entityId: "comm-gudok", entityTitle: "Сверкер" },
        { type: "coordinates_with", entityId: "master-gideon", entityTitle: "Гидеон" }
    ],
    media: [],
    evidenceIds: ["ev::signal-incident-t7"],
    changelog: [{ version: "1.0", date: "410 OВ", author: "System", summary: "Initial record creation." }],
    parameters: [
        { key: "will", name: "Воля", description: "Решимость и ментальная стойкость персонажа.", min: 0, max: 100, step: 1, defaultValue: 75, canonValue: 75, category: 'core' },
        ...
        { key: "ideology_rigidity", name: "Жесткость идеологии", description: "Жесткость убеждений.", min: 0, max: 100, step: 1, defaultValue: 40, canonValue: 40, category: 'limitations' },
