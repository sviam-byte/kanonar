...
const data: CharacterEntity = {
    ...
    status: "published",
    tags: ["юг-5", "смена", "быт", "рабочий"],
    description: "Добродушный сменщик. Стоик, верит в маленькие добрые дела.",
    relations: [
        { type: "befriends", entityId: "common_worker_delta", entityTitle: "Кетиль" }
    ],
    media: [],
    evidenceIds: [],
