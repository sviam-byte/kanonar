...
const data: CharacterEntity = {
    entityId: "legal-bot-9",
    type: EntityType.Character,
    title: "Верданди‑9",
    subtitle: "Юридический бот",
    authors: [{ name: "system", role: "Source" }],
    year: "410",
    versionTags: [Branch.Current],
    status: "published",
    tags: ["ИИ", "закон", "архив сводов", "процедуры"],
    description: "Алгоритм буквы закона. Параграф как истина, процедура как путь.",
    relations: [
        { type: "serves", entityId: "sector-admin-bot", entityTitle: "Скульд" }
    ],
    media: [],
    evidenceIds: [],
    changelog: [{ version: "1.0", date: "410 OВ", author: "System", summary: "Initial record creation." }],
    parameters: [
        { key: "will", name: "Воля", description: "Решимость и ментальная стойкость персонажа.", min: 0, max: 100, step: 1, defaultValue: 90, canonValue: 90, category: 'core' },
        ...
        { key: "topo", name: "Топо", description: "Личная топологическая стабильность.", min: 0, max: 100, step: 1, defaultValue: 100, canonValue: 100, category: 'core' },
        ...
        { key: "mandate_reg", name: "Регуляторный мандат", description: "Регуляторные полномочия.", min: 0, max: 100, step: 1, defaultValue: 80, canonValue: 80, category: 'mandates' },
        ...
        { key: "competence_op", name: "Операционная комп.", description: "Операционная/логистическая компетентность.", min: 0, max: 100, step: 1, defaultValue: 90, canonValue: 90, category: 'abilities' },
        ...
        { key: "intel_access", name: "Доступ к данным", description: "Доступ к разведданным/информации.", min: 0, max: 100, step: 1, defaultValue: 100, canonValue: 100, category: 'abilities' },
