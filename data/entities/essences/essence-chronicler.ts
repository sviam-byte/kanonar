...
const data: EssenceEntity = {
  ...
  status: "published",
  tags: [],
  description: "Текущий носитель сигиллы Хроникёра.",
  relations: [
    { type: 'is_advisor_to', entityId: 'essence-corona', entityTitle: 'Маэра Альб' },
    { type: 'is_brother_of', entityId: 'essence-mech', entityTitle: 'Вестар' },
  ],
  media: [
    {
      type: 'image',
  ...
  parameters: [
    { key: "will", name: "Воля", description: "Решимость и ментальная стойкость.", min: 0, max: 100, step: 1, defaultValue: 70, canonValue: 70, category: 'core' },
    { key: "loyalty", name: "Лояльность", description: "Приверженность фракции или идее.", min: 0, max: 100, step: 1, defaultValue: 90, canonValue: 90, category: 'core' },
    { key: "stress", name: "Стресс", description: "Психологическое и операционное давление.", min: 0, max: 100, step: 1, defaultValue: 20, canonValue: 20, category: 'core' },
    ...
    { key: "topo", name: "Топо", description: "Онтологическая целостность личности.", min: 0, max: 100, step: 1, defaultValue: 10, canonValue: 10, category: 'core' },
    ...
    { key: "reputation", name: "Репутация", description: "Легитимность и авторитет.", min: 0, max: 100, step: 1, defaultValue: 80, canonValue: 80, category: 'abilities' },
    ...
    { key: "resources", name: "Ресурсы", description: "Доступ к материальным и иным активам.", min: 0, max: 100, step: 1, defaultValue: 50, canonValue: 50, category: 'abilities' },
