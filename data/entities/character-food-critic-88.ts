...
const data: CharacterEntity = {
    ...
    status: "published",
    tags: ["еда", "сарказм", "обзоры", "Гамма-9"],
    description: "Сатирик общепита. Тонкий яд вместо смайлов. Терапия общества через иронию.",
    relations: [
        { type: "mocks", entityId: "sector-admin-bot", entityTitle: "Скульд" }
    ],
    media: [],
    evidenceIds: [],
