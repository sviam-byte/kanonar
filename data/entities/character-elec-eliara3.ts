...
const data: CharacterEntity = {
    entityId: "elec-eliara3",
    type: EntityType.Character,
    title: "Ульв",
    subtitle: "Электрик Элиара-3",
    authors: [{ name: "auto_extract", role: "Source" }],
    year: "410",
    versionTags: [Branch.Current],
    status: "published",
    tags: ["электрик", "Элиара-3", "ремонт", "быт"],
    description: "Рабочий-ремонтник. Видел странности на смене, но держится протокола.",
    relations: [
        { type: "works_with", entityId: "techie-linus", entityTitle: "Линн" }
    ],
    media: [],
    evidenceIds: [],
