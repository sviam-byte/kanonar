...
| `phase1` | communication threat, object context, location props, threat memory, prior influence, PAM v2, S5 OpponentBelief dual-emit | обычный пользовательский запуск с наблюдаемыми механизмами |
