...
Следующий пакет: `GOALENERGY-UNION-DEFAULT` — решить default объединённого
active-goal/domain словаря как минимум для `phase1`, сохранив legacy и
no-profile identity. После него — live wiring canonical Conflict provider;
R6 generalized schema следует после runtime migration. R2b metric catalog
остаётся после сценового goal-conflict runtime. Live replacement прочих
