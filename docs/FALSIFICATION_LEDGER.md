...
| NOISE-DOM | S8 choice reflects Q differences at probe temperature (T≈1.25, tieBand 0.08×1.4, Gumbel std≈1.28 vs Q gaps 0.05–0.25) | CRAFT/impl | OPEN | analysis only (2026-07-02); constants deliberately NOT tuned | v3 interaction row: axis→outcome slope NOT larger at T=0.1 than at T=0.9 would kill the noise-domination story · `outcome_triage_v3.py` interaction cells |
