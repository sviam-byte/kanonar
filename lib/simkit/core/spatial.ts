...
// Resolve an actor's map coordinates within its current location.
...
// Distance between two characters if they share a location; otherwise Infinity.
...
// Determine whether a listener can hear the speaker based on volume and privacy.
