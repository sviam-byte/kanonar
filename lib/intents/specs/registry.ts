...
export const INTENT_SPECS_V1: IntentSpecV1[] = [
  // ═══════════════════════════ MOVEMENT ═══════════════════════════
  {
    ...
    scoreModifiers: [
      ...
      { kind: 'weighted_appraisal', tag: 'danger_to_self', weight: 0.5, clamp: [0, 0.8] },
    ],
  ...
  },
  {
    ...
    scoreBase: 0.04,
    scoreModifiers: [
      { kind: 'weighted_metric', metric: 'hazard', weight: 1.2, clamp: [0, 1.5] },
    ],
  ...
  },
  {
    ...
    scoreBase: 0.03,
    scoreModifiers: [
      { kind: 'weighted_metric', metric: 'distance', weight: 0.15, clamp: [0, 0.5] },
    ],
